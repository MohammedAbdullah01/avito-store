        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        @include('admin.pages.products.modal.create')
                            ...
                            <tbody>
                                @forelse ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            @include('admin.pages.products.modal.show')
                                            {{-- End Modal Show product --}}

                                            @include('admin.pages.products.modal.edit')
                                            {{-- End Modal Edit product --}}

                                            @include('admin.pages.products.modal.delete')
